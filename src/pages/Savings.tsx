...
const SVG_ICONS: Record<string, React.ReactNode> = {
  GBP: (
    <svg fill='#ffffff' width='25px' height='25px' viewBox='0 0 20 20' stroke='#ffffff'>
      <g>
  ...
  EUR: (
    <svg fill='#ffffff' width='20px' height='20px' viewBox='0 0 310.75 310.75' stroke='#ffffff'>
      <g>
...
const DefaultIcon: React.FC = () => (
  <svg fill='#ffffff' width='20px' height='20px' viewBox='0 0 24 24' stroke='#ffffff'>
    <circle cx='12' cy='12' r='10' fill='none' strokeWidth='2' />
    <text x='12' y='16' textAnchor='middle' fill='#ffffff' fontSize='12'>
      $
    </text>
  </svg>
);
...
const Savings: React.FC = () => {
  ...
  useEffect(() => {
    apiGet<CurrencyData[]>('/api/savings/currencies')
      .then((data) => {
        setCurrencies(data);
      })
      .finally(() => {
        ...
        {isLoading ? (
          ...
          currencies.map((currency) => (
            <Currency
              ...
              active={selected === currency.short_name}
              onSelect={() => {
                handleOnSelect(currency.short_name);
              }}
            >
              {currency.svg_icon ? (
                <span dangerouslySetInnerHTML={{ __html: currency.svg_icon }} />
              ) : (
                (SVG_ICONS[currency.short_name] ?? <DefaultIcon />)
              )}
            </Currency>
          ))
        )}
